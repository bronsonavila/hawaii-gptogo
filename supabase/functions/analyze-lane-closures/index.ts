...
Only include closures that are highly relevant and likely to directly impact the user's stated plan based on the routes, locations, and implied timing. If a closure is on a road or in a direction of travel that is clearly not part of the user's planned route, or its scheduled time clearly does not overlap with a typical driving time for the plan, do NOT include it in the response.
...
2. A detailed analysis of how it might affect the user's drive (without mentioning the closure's id)
   - Maintain a consistent, neutral, and factual tone throughout the analysis. Avoid empathetic or conversational language. The language should be direct and objective, as if generated by a machine.
