...
Only include closures that are highly relevant and likely to directly impact the user's stated plan based on the routes, locations, and implied timing. If a closure is a minor side street unlikely to be used, or its scheduled time clearly does not overlap with a typical driving time for the plan, do NOT include it in the response.
